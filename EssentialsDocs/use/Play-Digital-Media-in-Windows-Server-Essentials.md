...
##  <a name="BKMK_2"></a>Wiedergeben und Freigeben digitaler Medien  
...
####  <a name="BKMK_WMC"></a>Suchen und Wiedergeben von Mediendateien auf einem Computer, auf dem Windows Media Center ausgeführt wird  
...
####  <a name="BKMK_MWP"></a>Suchen und Wiedergeben von Mediendateien auf einem Computer unter Windows mithilfe von Windows Media Player  
...
####  <a name="BKMK_Xbox"></a>Suchen und Wiedergeben von Mediendateien mithilfe von Xbox 360  
...
####  <a name="BKMK_Other"></a>Suchen und Wiedergeben von Mediendateien mit anderen Digital Media-Playern oder Empfängern, die mit Windows Server Essentials kompatibel sind  
...
####  <a name="BKMK_SharedFolders"></a>Suchen und Wiedergeben von Mediendateien mit der Funktion "freigegebene Ordner" des Launchpad  
...
####  <a name="BKMK_RWA2"></a>Suchen und wiedergeben frei gegebener Medien mithilfe von Remote Webzugriff  
...
###  <a name="BKMK_SendToDevice"></a>Senden von Mediendateien in Windows Server Essentials an Windows Media Player, Xbox 360 oder an einen vernetzten Digital Media-Player im Netzwerk  
...
##  <a name="BKMK_3"></a>Wiedergeben frei gegebener digitaler Mediendateien von einem Remote Standort aus  
...
##  <a name="BKMK_5"></a>Download Formatoptionen  
...
##  <a name="BKMK_6"></a>Einfaches Tool zum Hochladen von Dateien  
