...
-   [Herstellen einer Verbindung mit dem Server von Ihrem lokalen Netzwerk aus](Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md#BKMK_ConnectServer)
...
-   **Zugriff auf SharePoint Online-Team Websites und-Bibliotheken** : nutzen Sie Microsoft 365 Integration in Windows Server Essentials, um auf SharePoint Online-Team Websites zuzugreifen und Dokumente in Ihren SharePoint Online-Bibliotheken in My Server 2012 R2 zu öffnen.
...
##  <a name="operating-system-requirements"></a><a name="BKMK_OS"></a> Betriebssystemanforderungen
...
2.  Wenn Sie in der Lage sein möchten, den Servernamen für die Verbindung mit Ihrem Windows Server Essentials-Server über ein Intranet zu verwenden, und Ihr Gerät das Betriebssystem Windows 8 oder Windows RT aufweist, installieren Sie das Standard Zertifikat "caroot. cer" auf dem Computer, indem Sie das folgende Verfahren ausführen. Die manuelle Installation eines Zertifikats ist in Windows 8.1 und Windows RT 8,1 nicht erforderlich.
...
2.  Geben Sie in der Adressleiste **http://<IhrServername \> /Connect/default.aspx? Get = caroot. CER**ein, und drücken Sie dann die EINGABETASTE.
