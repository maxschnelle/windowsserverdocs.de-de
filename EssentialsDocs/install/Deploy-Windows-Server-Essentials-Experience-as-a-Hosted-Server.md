 ...
 **Syntax**:  
 ...
 Add-wssuser [-Name] < Zeichenfolge\> [-password] < SecureString\> [-AccessLevel < String\> { &#124; User Administrator}] [-FirstName < String\>] [-LastName < String\>] [-allowremoteaccess] [-allowvpnaccess] [< CommonParameters\>]  
