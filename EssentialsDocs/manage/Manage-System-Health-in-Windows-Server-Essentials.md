...
-   [Info zum Add-In für den Integritätsbericht](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_AddIn)

-   [Anzeige von Warnungen in der Meldungsanzeige](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_View)
...
-   [Erstellen eines Berichts auf Anforderung oder nach Zeitplan](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Generate)

-   [Anpassen des Inhalts des Berichts](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Customize)

-   [E-Mailen des Berichts](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_emailreport)
...
- **Serversicherung** Die Informationen über die letzte Serversicherung werden im Detailabschnitt**** des Berichts aufgeführt.

- **Nicht ausgeführte Autostartdienste** Wenn zum Zeitpunkt der Berichterstellung kein Autostartdienst ausgeführt wird, werden die Informationen zu diesem Dienst im Abschnitt **Details** des Berichts aufgeführt.

- **Updates** Im Detailabschnitt**** wird der Updatestatus des Servers und aller Clientcomputer angezeigt.

- **Speicher** Im Abschnitt **Details** wird die Liste der Treiber und ihre Kapazität aufgeführt.
...
-   [Warnung aktivieren](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_5)
...
-   Ihr Microsoft 365 Abonnement ist abgelaufen.

-   Die Microsoft 365 Authentifizierung war nicht erfolgreich.

-   Die Kennwortrichtlinie ist falsch.

-   Der Kenn Wort Synchronisierungs Dienst kann ein Benutzer Kennwort nicht mit Microsoft 365 synchronisieren.

-   Eigenes Windows-Kennwort ändern.

-   Ihr Microsoft 365 Kennwort entspricht nicht dem Windows-Kennwort.
...
|Virenschutz ist deaktiviert, nicht installiert oder nicht auf dem neuesten Stand.|Die Daten auf Ihrem Computer sind gefährdet, wenn die **Virenschutz**-Sicherheitseinstellung deaktiviert oder nicht aktualisiert ist. [Zum Schutz Ihres Computers](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Protect) befolgen Sie die angegebenen Schritte.|
|Der Schutz gegen Spyware und unerwünschte Software ist deaktiviert, nicht installiert oder nicht auf dem neuesten Stand.|Die Daten auf Ihrem Computer sind gefährdet, wenn der **Schutz vor Spyware und unerwünschter Software** deaktiviert oder nicht aktualisiert ist. [Zum Schutz Ihres Computers](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Protect) befolgen Sie die angegebenen Schritte.|
...
|Mindestens ein Dienst wird nicht ausgeführt.||
|Eigenes Windows-Kennwort ändern.||
|Ihr Microsoft Microsoft 365-Kennwort ist nicht mit dem Windows-Kennwort identisch.||
