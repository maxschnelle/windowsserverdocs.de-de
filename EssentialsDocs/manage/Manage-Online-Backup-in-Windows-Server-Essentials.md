...
1.  **Auswählen einer Onlinesicherung, aus der Dateien und Ordner wiederhergestellt werden sollen**
...
2.  **Auswählen eines Servers, von dem Dateien und Ordner wiederhergestellt werden sollen**
...
3.  **Auswählen eines Volumes, das die wiederherzustellenden Dateien und Ordner enthält**
...
4.  **Auswählen von Dateien und Ordnern, die wiederhergestellt werden sollen**
...
-   [Ändern der Richtlinie für die Onlinesicherung](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_7)

-   [Anzeigen der Auslastung des Speichers für die Onlinesicherung](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_8)
...
-   [Beenden einer laufenden Onlineserversicherung](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_12)
...
-   [Zurücksetzen der Onlinesicherung auf die Standardeinstellungen](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_15)

-   [Anmelden beim Azure Backup-Dienst](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_16)

-   [Integration von Azure Backup in Windows Server Essentials](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_17)
