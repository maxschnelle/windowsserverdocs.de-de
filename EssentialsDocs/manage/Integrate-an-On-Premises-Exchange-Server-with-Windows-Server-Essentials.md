...
> [!NOTE]
>  Wenn Sie anstelle eines selbst ausgegebenen Zertifikats ein öffentlich vertrauenswürdiges SSL-Zertifikat verwenden möchten, können Sie die Anweisungen im Installationshandbuch befolgen, um eine Zertifikat Anforderung zu erstellen und an die ausgewählte Zertifizierungsstelle zu senden. Sie können auch ein Exchange PowerShell-Cmdlet verwenden, um eine Zertifikatanforderung zu erstellen. Ein Beispiel folgt.
>
