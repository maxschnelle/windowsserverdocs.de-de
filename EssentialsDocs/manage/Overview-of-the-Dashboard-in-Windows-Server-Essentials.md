...
- [Features der Startseite des Dashboards](#BKMK_Home)  
  
- [Administrative Abschnitte des Dashboards](#BKMK_Features)  
  
- [Zugreifen auf das Windows Server Essentials-Dashboard](#BKMK_AccessDb)  
  
- [Verwenden des abgesicherten Modus](#BKMK_UseSafeMode)  
  
##  <a name="basic-features-of-the-dashboard"></a><a name="BKMK_Design"></a>Grundlegende Features des Dashboards  
 Das Windows Server Essentials-Dashboard hilft Ihnen, rasch auf wichtige Informationen und Verwaltungs-Features des Servers zuzugreifen. Das Dashboard umfasst mehrere Abschnitte. In der folgenden Tabelle werden die Abschnitte beschrieben.  
...
|5|Aufgabenbereich|Der Aufgabenbereich enthält Links zu Informationen und Tools, die Sie dabei unterstützen, die Eigenschaften für ein bestimmtes Objekt (z. B. ein Benutzerkonto oder einen Computer) oder globale Einstellungen für die Objektkategorie zu verwalten. Der Aufgabenbereich ist in die folgenden zwei Abschnitte unterteilt:<br /><br /> **Objekt Aufgaben** , die Sie unterstützen, enthält Links zu Tools und Informationen, mit denen Sie die Eigenschaften für ein Objekt verwalten können, das Sie in der Listenansicht auswählen (z. b. ein Benutzerkonto oder einen Computer).<br /><br /> **Globale Aufgaben** sind Links zu Tools und Informationen enthalten, die Sie bei der Verwaltung globaler Aufgaben für einen Funktionsbereich unterstützen. Globale Aufgaben umfassen Aufgaben, um neue Objekte hinzuzufügen, Richtlinien festzulegen usw.|  
...
|7|Status der Benachrichtigungen|Der Status der Benachrichtigungen liefert eine rasche Übersicht von Informationen über den Zustand des Servers. Klicken Sie auf das Warnungsbild, um kritische und wichtige Warnungen anzuzeigen.<br /><br /> **Hinweis:** In Windows Server Essentials und Windows Server 2012 R2 Standard mit installierter Rolle "Windows Server Essentials-Umgebung" ist der Status Warnungen auf der Registerkarte **Informationen und Einstellungen** verfügbar.|  
...
##  <a name="administrative-sections-of-the-dashboard"></a><a name="BKMK_Features"></a>Administrative Abschnitte des Dashboards  
