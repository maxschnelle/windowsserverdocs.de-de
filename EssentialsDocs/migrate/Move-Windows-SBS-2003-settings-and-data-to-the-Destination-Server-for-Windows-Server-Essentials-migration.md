---
title: "Verschieben von Windows SBS 2003-Einstellungen und Daten auf den Zielserver für Windows Server Essentials-migration"
...
---
# <a name="move-windows-sbs-2003-settings-and-data-to-the-destination-server-for-windows-server-essentials-migration"></a>Verschieben von Windows SBS 2003-Einstellungen und Daten auf den Zielserver für Windows Server Essentials-migration

>Gilt für: Windows Server2016 Essentials, Windows Server2012 R2 Essentials, Windows Server2012 Essentials

Verschieben von Einstellungen und Daten wie folgt auf den Zielserver:

1.  [Kopieren von Daten auf dem Zielserver](Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_CopyData)  
...
2.  Klicken Sie auf **starten**, Typ **Cmd** in das Suchfeld ein, und drücken Sie dann die EINGABETASTE.  
...
4.  Wiederholen Sie den vorherigen Schritt für jeden freigegebenen Ordner, den Sie vom Quellserver migrieren.  
...
##  <a name="BKMK_RemoveScripts"></a>Entfernen Sie ALTER Anmeldeskripts (optional)  
 Windows SBS 2003 verwendet Anmeldeskripts für Aufgaben wie das Installieren von Software und Anpassen von Desktops.  Windows Server Essentials ersetzt die Windows SBS 2003-Anmeldeskripts durch eine Kombination aus Anmeldeskripts und Gruppenrichtlinienobjekten.  
  
> [!NOTE]
>  Wenn Sie die Windows SBS 2003-Anmeldeskripts geändert haben, sollten Sie die Skripts aus, um Ihre Anpassungen beizubehalten umbenennen.  
  
> [!NOTE]
>  Windows SBS 2003-Anmeldeskripts gelten nur für Benutzerkonten, die mithilfe von hinzugefügt wurden die **Assistent zum Hinzufügen neuer Benutzer**.  
  
#### <a name="to-remove-the-windows-sbs-2003-logon-scripts"></a>So entfernen Sie die Windows SBS 2003-Anmeldeskripts  
  
1.  Klicken Sie auf **starten**, zeigen Sie auf **Verwaltung**, und klicken Sie dann auf **Active Directory-Benutzer und-Computer**.  
  
2.  In **Active Directory-Benutzer und-Computer**, erweitern Sie Ihr Netzwerk, und klicken Sie dann auf **Benutzer**.  
  
3.  Mit der rechten Maustaste in eines Benutzernamen ein, klicken Sie auf **Eigenschaften**, und klicken Sie dann auf die **Profil** Registerkarte.  
  
4.  Löschen Sie den Inhalt von der **Anmeldeskript** Textfeld ein, und klicken Sie dann auf **OK**.  
...
> [!NOTE]
>  Wenn Sie die ursprünglichen Windows SBS 2003 Gruppenrichtlinienobjekte geändert haben, sollten Sie Kopien davon an einem anderen Speicherort speichern und löschen Sie sie aus Windows SBS 2003.  
...
6.  Wiederholen Sie Schritt 5, um die folgenden Gruppenrichtlinienobjekte zu löschen, die für Ihr Netzwerk gelten:  
    ...
    -   Small Business Server Update Services-Clientcomputerrichtlinie  
         ...
         Dieses Gruppenrichtlinienobjekt ist vorhanden sein, wenn Sie von Windows SBS 2003 R2 migrieren.  
...
3.  Folgen Sie den Anweisungen in der **"Zugriff überall" einrichten** Assistenten zum Konfigurieren der Router und Domänennamen ein.  
...
##  <a name="BKMK_MapPermittedComputers"></a>Ordnen Sie zugelassener Computer zu Benutzerkonten zu  
 Wenn ein Benutzer eine Verbindung mit Remote Web Access herstellt, werden alle Computer im Netzwerk in Windows SBS 2003 angezeigt. Dies kann Computer umfassen, die der Benutzer nicht über die Berechtigung zum Zugriff auf. In Windows Server Essentials muss ein Benutzer explizit einem Computer, damit er in Remote Web Access angezeigt werden zugewiesen werden. Jedes Benutzerkonto, das von Windows SBS 2003 migriert wird, muss einem oder mehreren Computern zugeordnet werden.  
...
6.  Klicken Sie auf die **Zugriff auf den Computer** Registerkarte, und klicken Sie auf den Namen des Computers, zu dem Sie den Zugriff zulassen möchten.  
