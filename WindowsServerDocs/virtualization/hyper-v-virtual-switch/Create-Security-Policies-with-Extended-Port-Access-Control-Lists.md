...
-   [Erzwingen der Sicherheit auf Benutzer- und auf Anwendungsebene](#bkmk_both)
...
|Quell-IP|Ziel-IP|Protocol|Quellport|Zielport|Direction|Aktion|
|-------------|------------------|------------|---------------|--------------------|-------------|----------|
|*|*|TCP|*|3389|Geben Sie in|Allow|
...
### <a name="enforce-both-user-level-and-application-level-security"></a><a name="bkmk_both"></a>Erzwingen der Sicherheit auf Benutzer- und auf Anwendungsebene
...
|Quell-IP|Ziel-IP|Protocol|Quellport|Zielport|Direction|Aktion|
|-------------|------------------|------------|---------------|--------------------|-------------|----------|
|*|255.255.255.255|UDP|*|67|aus|Allow|
|*|10.175.124.0/25|UDP|*|67|aus|Allow|
|10.175.124.0/25|*|UDP|*|68|Geben Sie in|Allow|
...
## <a name="stateful-acl-rules"></a><a name="bkmk_stateful"></a>Zustandsbehaftete ACL-Regeln
...
|Quellport|*|*|*|
|Zielport|*|*|80|
|Direction|Geben Sie in|aus|aus|
|Aktion|Verweigern|Verweigern|Allow|
