...
|Komponente|Maximal|Hinweise|  
|-------------|-----------|---------|  
|Logische Prozessoren|512|Beide müssen in der Firmware aktiviert werden:<br /><br />-Hardware gestützte Virtualisierung<br />-Hardware erzwungene Daten Ausführungs Verhinderung (Data Execution Prevention, DEP)<br /><br />Für das Host Betriebssystem (Stamm Partition) werden nur die maximalen 320 logischen Prozessoren angezeigt.|  
