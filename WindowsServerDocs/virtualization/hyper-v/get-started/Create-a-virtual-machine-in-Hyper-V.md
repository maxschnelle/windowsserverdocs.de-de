...
## <a name="create-a-virtual-machine-by-using-hyper-v-manager"></a>Erstellen eines virtuellen Computers mit Hyper-V-Manager  
...
4.  Stellen Sie der entsprechenden Optionen für den virtuellen Computer, auf den einzelnen Seiten. Weitere Informationen finden Sie unter [neuer virtueller Computer – Optionen und Standardwerte in Hyper-V-Manager](#options-in-hyper-v-manager-new-virtual-machine-wizard) weiter unten in diesem Thema.  
...
## <a name="options-in-hyper-v-manager-new-virtual-machine-wizard"></a>Optionen im Assistenten für neue Hyper-V-Manager-VM  
...
- [Versionen von unterstützten VM-Konfiguration](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#supported-virtual-machine-configuration-versions)  
