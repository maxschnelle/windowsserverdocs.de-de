---
title: Ein virtuellen Computer Windows Server 2012 R2 ausgeführt wird und mit dynamischem Arbeitsspeicher konfiguriert sollten empfohlene Werte für die Einstellungen für den Arbeitsspeicher verwenden.
...
ms.locfileid: "59890161"
---
# <a name="a-virtual-machine-running-windows-server-2012-r2-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>Ein virtuellen Computer Windows Server 2012 R2 ausgeführt wird und mit dynamischem Arbeitsspeicher konfiguriert sollten empfohlene Werte für die Einstellungen für den Arbeitsspeicher verwenden.
...
*Eine oder mehrere virtuelle Computer sind mit weniger als die Menge an Arbeitsspeicher empfohlen für Windows Server 2012 R2 für die Verwendung von dynamischem Arbeitsspeicher konfiguriert.*  
...
*Verwenden Sie Hyper-V-Manager, um den minimalen Arbeitsspeicher an, mindestens 256 MB, startspeicher auf mindestens 512 MB und der maximale Arbeitsspeicher auf mindestens 2 GB für diesen virtuellen Computer zu erhöhen.*  
