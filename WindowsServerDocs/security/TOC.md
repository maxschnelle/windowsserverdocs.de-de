...
##### [Verwenden von VMM](/system-center/vmm/guarded-deploy-host?toc=%2fwindows-server%2fvirtualization%2ftoc.json)
...
## [Deaktivieren von benutzerbezogenen Diensten in Windows](/windows/application-management/per-user-services-in-windows)
...
### [Schützen von Remotedesktop-Anmeldeinformationen mit Remote Credential Guard](/windows/security/identity-protection/remote-credential-guard)
