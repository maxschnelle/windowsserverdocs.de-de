...
### <a name="windows-server-security-blog-posthttpsblogstechnetmicrosoftcomwindowsserver20160425ten-reasons-youll-love-windows-server-2016-8-security"></a>[Windows Server Security-Blogbeitrag](https://blogs.technet.microsoft.com/windowsserver/2016/04/25/ten-reasons-youll-love-windows-server-2016-8-security/)
...
### <a name="datacenter-and-private-cloud-security-bloghttpsblogstechnetmicrosoftcomdatacentersecurity"></a>[Datacenter and Private Cloud Security-Blog](https://blogs.technet.microsoft.com/datacentersecurity/)
Dies ist die zentrale Blogwebsite für technische Inhalte des Microsoft Datacenter and Private Cloud Security-Teams.                                    

### <a name="addressing-emerging-threats-and-landscape-shiftshttpswwwyoutubecomwatchvb5jmyxywx1kfeatureyoutube"></a>[Adressieren von neuen Bedrohungen und Querformat wechselt](https://www.youtube.com/watch?v=B5JMYxYWx1k&feature=youtu.be)
...
### <a name="protecting-your-datacenter-and-cloud-from-emerging-threats-blog-posthttpblogstechnetcombwindowsserverarchive20151118protecting-your-datacenter-and-cloud-november-updateaspx"></a>[Schützen Ihr Rechenzentrum und Cloud Blogbeitrag Emerging Threats](http://blogs.technet.com/b/windowsserver/archive/2015/11/18/protecting-your-datacenter-and-cloud-november-update.aspx)
...
### <a name="security-and-assurance-overview-session-at-ignitehttpchannel9msdncomeventsignite2015brk2482"></a>[Auf der Ignite-Sitzung Assurance Übersicht über Sicherheit und](http://channel9.msdn.com/events/ignite/2015/brk2482)
...
### <a name="shielded-vm-demohttpswwwyoutubecomwatchvxip5qtk-7d8"></a>[Demo zu abgeschirmten VMs](https://www.youtube.com/watch?v=xip5Qtk-7d8)
...
### <a name="shielded-virtual-machines-in-windows-server-video-walkthroughhttpmicrosoft-cloudcloudguidescomguidesshielded-virtual-machines-in-windows-serverhtm"></a>[Geschützte virtuelle Maschinen in Windows Server-video zur exemplarischen Vorgehensweise](http://microsoft-cloud.cloudguides.com/Guides/Shielded Virtual Machines in Windows Server.htm)
In diesem Video mit exemplarischer Vorgehensweise wird gezeigt, wie der Host-Überwachungsdienst die Verwendung abgeschirmter virtueller Computer ermöglicht, um Daten gegen einen nicht autorisierten Zugriff durch Hyper-V-Hostadministratoren zu schützen.

### <a name="harden-the-fabric-protecting-tenant-secrets-in-hyper-v-ignite-videohttpchannel9msdncomeventsignite2015brk3457"></a>[Absichern des Fabrics: Schützen die Mandanten-Geheimnisse in Hyper-V (Ignite-Video)](http://channel9.msdn.com/events/ignite/2015/brk3457)

Diese Ignite-Präsentation erläutert Erweiterungen in Hyper-V, Virtual Machine Manager sowie eine neue Host Guardian-Serverrolle zur Aktivierung von abgeschirmten VMs.                

### <a name="guarded-fabric-deployment-guidehttpsdocsmicrosoftcomwindows-servervirtualizationguarded-fabric-shielded-vmguarded-fabric-deploying-hgs-overview"></a>[Geschütztes Fabric-Bereitstellungshandbuch](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-deploying-hgs-overview)
Dieser Leitfaden umfasst Installations- und Validierungsinformationen für Windows Server und System Center Virtual Machine Manager für Hosts mit geschütztem Fabric und abgeschirmte VMs.

### <a name="shielded-vm-and-guarded-fabric-in-branch-officeshttpsdocsmicrosoftcomwindows-servervirtualizationguarded-fabric-shielded-vmguarded-fabric-manage-branch-office"></a>[Geschützte VMs und geschütztes Fabric in Zweigstellen](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-manage-branch-office)
Dieses Handbuch enthält bewährte Methoden für die Ausführung von abgeschirmten virtuellen Computern in Filialen und in anderen Remoteszenarien, in denen Hyper-V-Hosts Zeiträume mit eingeschränkter Konnektivität zu HGS haben können.

### <a name="shielded-vm-and-guarded-fabric-troubleshooting-guidehttpsdocsmicrosoftcomwindows-servervirtualizationguarded-fabric-shielded-vmguarded-fabric-troubleshoot-overview"></a>[Geschützte VMs und geschütztes Fabric Handbuch zur Problembehandlung](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-troubleshoot-overview)
...
### <a name="protecting-windows-and-microsoft-azure-active-directory-with-privileged-access-managementhttpchannel9msdncomeventsignite2015brk3873"></a>[Schützen von Windows und Microsoft Azure Active Directory mit Privileged Access Management](http://channel9.msdn.com/events/ignite/2015/brk3873)
...
### <a name="just-enough-administration-articlehttpakamsjea"></a>[Just Enough Administration-Artikel](http://aka.ms/JEA)
...
### <a name="just-enough-administration-demo-videohttpswwwyoutubecomwatchvxnbrbky9p20"></a>[Nur Enough Administration-Demo-video](https://www.youtube.com/watch?v=xnBrbkY9P20)
...
### <a name="credential-guard-demo-videohttpswwwyoutubecomwatchveupkogsl7yk"></a>[Demovideo zu Credential Guard](https://www.youtube.com/watch?v=eUpKOGSl7yk)
...
### <a name="windows-defender-application-control-wdac-deployment-guidehttpsdocsmicrosoftcomwindowssecuritythreat-protectionwindows-defender-application-controlwindows-defender-application-control"></a>[Windows Defender Application Control (WDAC)-Bereitstellungshandbuch](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-application-control/windows-defender-application-control)
...
Device Guard ist eine Kombination aus WDAC und Hypervisor-geschützter Codeintegrität (HVCI). In diesem 7-minütigen Video wird Device Guard und seine Verwendung auf Windows Server vorgestellt.

### <a name="transport-layer-security-registry-settingshttpsdocsmicrosoftcomwindows-serversecuritytlstls-registry-settings"></a>[Transport Layer Security-Registrierungseinstellungen](https://docs.microsoft.com/windows-server/security/tls/tls-registry-settings)
...
### <a name="oms-and-windows-serverhttpswwwyoutubecomwatchvsadw1dry2k"></a>[OMS und WindowsServer](https://www.youtube.com/watch?v=_SaDw1dRy2k)
...
### <a name="datacenter-firewall-overviewhttpstechnetmicrosoftcomlibrarydn920240aspx"></a>[Rechenzentrumsfirewall: Übersicht](https://technet.microsoft.com/library/dn920240.aspx)
...
### <a name="whats-new-in-dns-in-windows-serverhttpstechnetmicrosoftcomwindows-server-docsnetworkingdnswhat-s-new-in-dns-server"></a>[Neues in DNS unter WindowsServer](https://technet.microsoft.com/windows-server-docs/networking/dns/what-s-new-in-dns-server)
...
-   [Kompatibilitätszuordnung von abgeschirmten Hyper-V-VMs](https://download.microsoft.com/download/6/D/0/6D06E149-B4C1-4EED-ACD5-DF6066E93CC0/Coalfire_Branded_Hyper_V_Shielded_VMs_Whitepaper_EN_US.pdf)

-   [Kompatibilitätszuordnung von JEA und JIT-Kompilierung](https://download.microsoft.com/download/2/7/A/27A2B5BB-6B52-4482-87C1-DA9D6B6D8C8D/Coalfire_Branded_Privileged_Identity_Manager_Whitepaper_EN_US.pdf)

-   [Kompatibilitätszuordnung von Device Guard](https://download.microsoft.com/download/6/9/D/69D9E610-D23C-4F7E-A8CC-D65B87CEB4F8/Coalfire_Branded_Device_Guard_Whitepaper_EN_US.pdf)

-   [Kompatibilitätszuordnung von Credential Guard](https://download.microsoft.com/download/8/1/2/812009C9-E4B8-4D4B-AADD-FDC373D0A076/Coalfire_Branded_Credential_Guard_Whitepaper_EN_US.pdf)

-   [Kompatibilitätszuordnung von Windows Defender](https://download.microsoft.com/download/C/7/7/C778B7BB-0783-42D7-93A9-B86DFB5A7BAD/Coalfire_Branded_Windows_Defender_Whitepaper_EN_US.pdf)
