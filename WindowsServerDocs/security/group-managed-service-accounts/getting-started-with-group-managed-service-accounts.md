...
## <a name="BKMK_Prereqs"></a>Voraussetzungen
...
|Prinzipale|Umfang|Unterstützte Dienste|Kennwortverwaltung|
|-------|-----|-----------|------------|
...
|Element|Anforderungen|Betriebssystem|
|------|--------|----------|
