...
- \(richten Sie mithilfe eines virtuellen privaten Netzwerks \(VPN-\), DirectAccess oder einer anderen Verbindungsmethode ein WAN\) Verbindungen zwischen Ihrer Zweigstelle, ihrer Zentrale und ggf. ihren cloudressourcen ein.
...
Diese Infrastruktur besteht aus einer Gruppenrichtlinie-Engine und mehreren Client\-seitigen Erweiterungen \(CSEs-\), die für das Lesen von Richtlinien Einstellungen auf Ziel Client Computern zuständig sind.
