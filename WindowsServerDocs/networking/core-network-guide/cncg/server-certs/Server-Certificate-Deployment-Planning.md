...
Damit sich der Computer bei der Domäne anmelden kann, muss er Mitglied der Domäne sein, und das Benutzerkonto muss vor der Anmeldung in AD DS erstellt worden sein. Außerdem erfordern die meisten Prozeduren in diesem Handbuch, dass das Benutzerkonto Mitglied der Gruppe Organisations-Admins oder Domänen-Admins in Active Directory Benutzer und Computer ist. Daher müssen Sie sich bei der Zertifizierungsstelle mit einem Konto anmelden, das über die entsprechende Gruppenmitgliedschaft verfügt.
