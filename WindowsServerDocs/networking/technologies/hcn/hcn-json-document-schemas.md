---
title: JSON-Dokument Schemas für hostingcompute-Netzwerk (HCN)
description: Informationen zu HCN-JSON-Dokument Schemas.
ms.author: daschott
author: daschott
ms.date: 11/05/2018
...
ms.locfileid: "90083751"
---
# <a name="hcn-json-document-schemas"></a>HCN JSON-Dokumentschemas
...
## <a name="hcn-endpoint-schema"></a>HCN-Endpunkt Schema
...
## <a name="hcn-policy-schema"></a>Schema der HCN-Richtlinie
...
## <a name="hcn-notification-schema"></a>HCN-Benachrichtigungs Schema
...
## <a name="result-error-schema"></a>Ergebnis Fehler Schema
