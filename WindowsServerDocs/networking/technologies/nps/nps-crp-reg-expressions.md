...
**So ersetzen <em>user@example.microsoft.com</em> Sie durch *example. Microsoft. com\user***
...
**So ersetzen Sie " *Domäne \ Benutzer* " durch *specific_domain\user***
