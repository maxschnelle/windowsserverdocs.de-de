...
Abhängig vom switchkonfigurationsmodus und dem Auslastungs Verteilungs Algorithmus zeigt der NIC-Team Vorgang die kleinste Anzahl von verfügbaren und unterstützten Warteschlangen an, die von einem beliebigen Adapter im Team (Modus für min. Warteschlangen) oder von der Gesamtanzahl der für alle Teammitglieder verfügbaren Warteschlangen (Sum-of-Queues-Modus) verfügbar sind
...
Wenn Sie den NIC-Team Vorgang verwenden, ermöglicht die Erstellung mehrerer Team Schnittstellen, dass ein Host gleichzeitig eine Verbindung mit verschiedenen VLANs herstellt.
Konfigurieren Sie Ihre Umgebung mit den folgenden Richtlinien:
...
## <a name="virtual-machines-vms"></a>Virtuelle Computer (Virtual Machines, VMs)
