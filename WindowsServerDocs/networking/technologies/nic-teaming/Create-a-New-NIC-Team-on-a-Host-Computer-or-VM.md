...
## <a name="network-configuration-requirements"></a>Konfigurationsanforderungen für das Netzwerk
...
14. Klicken Sie unter **Hardware hinzufügen**auf **Netzwerk Adapter**, und klicken Sie dann auf **Hinzufügen**.
   ...
   ![Hinzufügen eines Netzwerkadapters](../../media/Create-a-New-NIC-Team-in-a-VM/nict_hvs_06.jpg)
