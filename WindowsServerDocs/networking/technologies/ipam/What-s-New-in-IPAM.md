...
>[!NOTE]
>Finden Sie in der IPAM-Windows-PowerShell-Befehlsreferenz [(IP Address Management, IPAM)-Server-Cmdlets in Windows PowerShell](https://docs.microsoft.com/powershell/module/ipamserver/).  
...
Weitere Informationen finden Sie unter [suchen-IpamFreeSubnet](https://docs.microsoft.com/powershell/module/ipamserver/Find-IpamFreeSubnet).  
...
Weitere Informationen finden Sie unter [suchen-IpamFreeRange](https://docs.microsoft.com/powershell/module/ipamserver/Find-IpamFreeRange).  
