...
-   **\-Standortbasierte Datenverkehrs Verwaltung** Mithilfe der DNS-Richtlinie können primäre und sekundäre DNS-Server auf DNS-Client Abfragen basierend auf dem geografischen Standort des Clients und der Ressource, mit der der Client eine Verbindung herstellen möchte, Antworten. dabei wird dem Client die IP-Adresse der nächstgelegenen Ressource bereitgestellt.
...
|**State**|Richtlinienstatus|-Enable (Standard)<br />-Deaktiviert|
...
|      **Internetprotokoll**      |        In der Abfrage verwendetes Netzwerkprotokoll. Mögliche Einträge sind **IPv4** und **IPv6** .        |                                                                                                                   -   **EQ, IPv4**<br />-   **EQ, IPv6**                                                                                                                    |
