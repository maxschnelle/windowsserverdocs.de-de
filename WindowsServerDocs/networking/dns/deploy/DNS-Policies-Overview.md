...
|**FQDN**|FQDN des Datensatzes in der Abfrage mit der Möglichkeit, einen Platzhalter verwenden|-   **EQ, www.contoso.com** -löst in Warteschlangen gesamt Rue nur die bei die Abfrage versucht, lösen die *www.contoso.com* FQDN<br />-   **EQ,\*. "contoso.com"\*. woodgrove.com** -aufgelöst wird, auf "true", wenn die Abfrage für einen Datensatz mit dem Endstand *"contoso.com"***oder***woodgrove.com*|  
