...
Um sicherzustellen, dass contosogiftservices.com-Kunden eine reaktionsfähige Umgebung von der Website erhalten, entscheidet der Dienst von "", dass der Dienst während dieser Zeit eine \( VM-VM \) auf Microsoft Azure, um eine Kopie des Webservers zu hosten.
...
Entsprechend wird im Standard Zonen Bereich \( contosogiftservices.com \) ein Datensatz \( www.contosogiftservices.com mit der \) IP-Adresse 192.68.30.2 des Webservers hinzugefügt, der im lokalen Rechenzentrum von Seattle ausgeführt wird.
