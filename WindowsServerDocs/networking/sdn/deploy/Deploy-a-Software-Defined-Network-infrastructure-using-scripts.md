...
description: In diesem Thema wird beschrieben, wie Sie eine Microsoft-Sdn-Infrastruktur (Software Defined Network) mithilfe von Skripts in Windows Server 2016 bereitstellen. steht
manager: grcusanz
...
> [!IMPORTANT]  
> Bevor Sie mit der Bereitstellung beginnen, müssen Sie Ihre Hosts und die physische Netzwerkinfrastruktur planen und konfigurieren. Weitere Informationen finden Sie unter [Planen einer softwaredefinierten Netzwerkinfrastruktur](../../sdn/plan/Plan-a-Software-Defined-Network-Infrastructure.md).  
