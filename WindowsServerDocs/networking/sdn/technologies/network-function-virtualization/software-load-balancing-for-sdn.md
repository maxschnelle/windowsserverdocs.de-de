...
Anders als bei einer herkömmlichen Load Balancer-Appliance, bei der der Test auf dem Gerät basiert und über die gesamte Verbindung verläuft, stammt der SLB-Test von dem Host, auf dem sich die DIP-Datei befindet, und wechselt direkt vom SLB-Host-Agent zum DIP, um die Arbeit auf die Hosts zu verteilen.
...
-   Muxes können hinzugefügt und aus dem MUX-Pool entfernt werden, ohne dass sich dies auf den SLB-Dienst auswirkt. Dies behält die SLB-Verfügbarkeit bei, wenn einzelne muxes gepatcht werden.
