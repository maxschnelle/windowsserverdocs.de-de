...
Die Hyper-V-Netzwerkvirtualisierung von Windows Server 2016 bietet eine Richtlinien basierte, softwaregesteuerte Netzwerkvirtualisierung, die den Verwaltungsaufwand reduziert, den Unternehmen bei der Erweiterung dedizierter IaaS-Clouds haben, und bietet cloudhostern eine bessere Flexibilität und Skalierbarkeit für die Verwaltung virtueller Computer, um eine höhere Ressourcennutzung zu erzielen.
...
|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Communityressourcen**  |     -   [Blog der Private Cloud-Architektur](/archive/blogs/privatecloud/cloud-datacenter-network-architecture-in-the-windows-server-8-era)<br />-Fragen stellen:[cloudnetfb@microsoft.com](mailto:%20cloudnetfb@microsoft.com)     |
