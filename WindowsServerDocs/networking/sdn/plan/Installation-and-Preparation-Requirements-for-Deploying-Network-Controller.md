...
- [Installieren Sie die Netzwerkcontroller-Serverrolle, die mithilfe des Server-Manager](../technologies/network-controller/Install-the-Network-Controller-server-role-using-Server-Manager.md)   
