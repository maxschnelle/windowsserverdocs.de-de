...
author: Teresa-Motiv
description: Beschreibt die Einstellungen, die für den Windows-Zeitdienst (W32Time) verfügbar sind, und die Tools, die zum Konfigurieren dieser Einstellungen verwendet werden können.
ms.author: v-tea
ms.date: 11/20/2020
ms.topic: article
