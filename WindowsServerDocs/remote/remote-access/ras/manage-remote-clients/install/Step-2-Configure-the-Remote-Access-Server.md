...
![Äquivalente Windows PowerShell-Befehle in Windows](../../../../media/Step-2-Configure-the-Remote-Access-Server/PowerShellLogoSmall.gif)***<em>PowerShell</em>***
...
## <a name="configure-the-deployment-type"></a><a name="BKMK_Deploy"></a>Konfigurieren des Bereitstellungstypen
...
## <a name="configure-the-remote-access-server"></a><a name="BKMK_Server"></a>Konfigurieren des RAS-Servers
...
## <a name="configure-the-infrastructure-servers"></a><a name="BKMK_Infra"></a>Konfigurieren des Infrastrukturservers
...
## <a name="configure-application-servers"></a><a name="BKMK_App"></a>Konfigurieren von Anwendungsservern
...
## <a name="configuration-summary-and-alternate-gpos"></a><a name="BKMK_GPO"></a>Zusammenfassung der Konfiguration und alternative Gruppenrichtlinienobjekte
