...
## <a name="BKMK_1.1"></a>Implementieren einer Bereitstellung auf einem einzelnen Server  
Bevor Sie eine Bereitstellung für mehrere Standorte konfigurieren können, müssen Sie wie unter Bereitstellen [eines einzelnen DirectAccess-Servers mit erweiterten Einstellungen](https://technet.microsoft.com/windows-server-docs/networking/remote-access/directaccess/single-server-advanced/deploy-a-single-directaccess-server-with-advanced-settings)beschrieben eine erweiterte Bereitstellung für den Remote Zugriff mit einem Server konfigurieren.  
