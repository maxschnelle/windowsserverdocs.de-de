...
-   Führen Sie für Server-Gruppenrichtlinien Objekte das PowerShell-Cmdlet aus, um zu ermitteln, welcher Domänen Controller mit einem bestimmten Einstiegspunkt verknüpft ist `Get-DAEntryPointDC -EntryPointName <name of entry point>` .
