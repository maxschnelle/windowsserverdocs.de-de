...
Nachdem der RADIUS-Server mit Software Verteilungs Token konfiguriert wurde, sind die Kommunikationsports geöffnet, ein gemeinsamer geheimer Schlüssel wurde erstellt, Benutzerkonten, die Active Directory entsprechen, die auf dem RADIUS-Server erstellt wurden, und der RAS-Server wurde als RADIUS-Authentifizierungs-Agent konfiguriert, dann muss der RAS-Server für die Unterstützung von OTP konfiguriert werden.
...
![Äquivalente Windows PowerShell-Befehle in Windows](../../../../media/Step-3-Configure-the-Remote-Access-Server-for-OTP/PowerShellLogoSmall.gif)**PowerShell**
...
Da Ihre DirectAccess-Clients Smartcards für den Zugriff auf das Intranet verwenden, können Sie auch die Authentifizierungsmechanismus-Sicherung, ein Feature von Windows Server 2008 R2, verwenden, um den Zugriff auf Ressourcen (z. b. Dateien, Ordner und Drucker) zu steuern, je nachdem, ob der Benutzer mit einem smartcardbasierten Zertifikat angemeldet ist. Die Authentifizierung des Authentifizierungsmechanismus erfordert eine Domänen Funktionsebene von Windows Server 2008 R2.
