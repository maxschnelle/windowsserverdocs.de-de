...
&#171;  [**Vorherige:** Erfahren Sie mehr über die Always On-VPN-Verbesserungen](always-on-vpn-enhancements.md)<br>
&#187;  [**Next:** Erfahren Sie mehr über die erweiterten Funktionen von Always On-VPN-](deploy/always-on-vpn-adv-options.md)
...
3. Das VPN-Gateway ist auch als ein Remote Authentication Dial-in User Service konfiguriert \(RADIUS\) Client; der VPN-RADIUS-Client, sendet die verbindungsanforderung an den Unternehmen/Unternehmenskonten NPS-Server für die anforderungsverarbeitung für die Verbindung.
...
>[!NOTE] 
>Andere DNS-entwirft, z. B. Split-Brain-DNS (mit dem gleichen Domänennamen intern und extern in separaten DNS-Zonen) oder unabhängig vom stagingstatus internen und externe Domänen (z. B. "contoso.Local" und "contoso.com") sind ebenfalls möglich. Weitere Informationen zum Bereitstellen von Split-Brain-DNS finden Sie unter [verwenden DNS-Richtlinien für Split /-Brain-DNS-Bereitstellung](../../../../networking/dns/deploy/split-brain-DNS-deployment.md).
