...
- **Quad- \- Core-Prozessor:** kann bis zu 16 Stationen unterstützen.
- **Quad- \- Core-Prozessor mit Multithreading:** kann bis zu 20 Stationen unterstützen.
- **Sechs \- Kern Prozessor mit Multithreading:** kann bis zu 24 Stationen unterstützen.
...
[Auswählen der Video Hardware](#selecting-video-hardware) 
 ...
 [Auswählen anderer Stations Peripheriegeräte](#selecting-other-station-peripheral-devices)auswählen von 
 [RDP \- over \- LAN \- Connected Station Hardware](#BKMK_SelectingRDP-over-LAN-connectedstationhardware) 
...
| BESCHREIBUNG | Verbunden mit Host Computer | Verbunden mit stationshub oder downstreamhub |
|--|--|--|
...
## <a name="selecting-rdp-over-lan-connected-station-hardware"></a><a name="BKMK_SelectingRDP-over-LAN-connectedstationhardware"></a>Auswählen von RDP \- over \- LAN- \- Connected Station-Hardware
