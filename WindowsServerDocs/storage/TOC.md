# [Speicher](storage.md)
## [Neues im Speicher](whats-new-in-storage.md)
## [Datendeduplizierung](data-deduplication/overview.md)
### [Neues bei der Datendeduplizierung](data-deduplication/whats-new.md)
...
#### [Namespacetyp auswählen](dfs-namespaces/choose-a-namespace-type.md)
#### [Erstellen eines DFS-Namespaces](dfs-namespaces/create-a-dfs-namespace.md)
#### [Migrieren eines domänenbasierten Namespace zum Windows Server2008-Modus](dfs-namespaces/migrate-a-domain-based-namespace-to-windows-server-2008-mode.md)
#### [Hinzufügen von Namespaceserver zu einem domänenbasierten DFS-Namespace](dfs-namespaces/add-namespace-servers-to-a-domain-based-DFS-namespace.md)
...
#### [Erlauben oder Verhindern von Verweisen und Clientfailbacks](dfs-namespaces/enable-or-disable-referrals-and-client-failback.md)
#### [Ändern des Zeitraums für die Zwischenspeicherung von Verweisen auf Clients](dfs-namespaces/change-the-amount-of-time-that-clients-cache-referrals.md)
...
#### [Aktivieren der zugriffsbasierten Aufzählungen für einen Namespace](dfs-namespaces/enable-access-based-enumeration-on-a-namespace.md)
...
### [DFS-Replikation: Häufig gestellte Fragen (FAQ)](dfs-replication/dfsr-faq.md)
...
### [SMB: Datei- und Ports sollte geöffnet sein](file-server/best-practices-analyzer/smb-open-file-sharing-ports.md)
### [Network File System (Übersicht)](nfs/nfs-overview.md)
### [Network File System bereitstellen](nfs/deploy-nfs.md)
### [NTFS-Übersicht](file-server/ntfs-overview.md)
...
#### [Bearbeiten der Eigenschaften der Dateiprüfungsvorlagen](fsrm/edit-file-screen-template-properties.md)
...
### [Bereitstellen von Roaming-Benutzerprofilen](folder-redirection/deploy-roaming-user-profiles.md)
...
### [Offlinedateien auf Ordner deaktivieren](folder-redirection/disable-offline-files-on-folders.md)
### [Immer offline-Modus aktivieren](folder-redirection/enable-always-offline.md)
...
### [iSCSI-Zielserver Skalierbarkeit Grenzwerte](iscsi/iscsi-target-server-limits.md)
...
### [Migrieren von einem server](storage-migration-service/migrate-data.md)
...
### [Replikation eines Stretched Clusters mithilfe von freigegebenem Speicher](storage-replica/stretch-cluster-replication-using-shared-storage.md)
...
### [Cluster-zu-Cluster Storage Replica cross-Bereich in Azure](storage-replica/cluster-to-cluster-azure-cross-region.md)
### [Cluster-zu-Cluster Storage Replica innerhalb desselben Bereichs in Azure](storage-replica/cluster-to-cluster-azure-one-region.md)
### [Speicherreplikate: Bekannte Probleme](storage-replica/storage-replica-known-issues.md)
### [Speicherreplikate: Häufig gestellte Fragen](storage-replica/storage-replica-frequently-asked-questions.md)
...
### [Gesundheit und Betriebsstatus](storage-spaces/storage-spaces-states.md)
...
#### [Cluster- und Pool-Quorum](storage-spaces/understand-quorum.md)
#### [Cluster-Gruppen](storage-spaces/cluster-sets.md)
### Plan
#### [Hardwareanforderungen](storage-spaces/storage-spaces-direct-hardware-requirements.md)
#### [Mithilfe der CSV-speicherinterne Lesecache](storage-spaces/csv-cache.md)
...
### Bereitstellen
#### [Bereitstellen von direkte Speicherplätze](storage-spaces/deploy-storage-spaces-direct.md)
#### [Erstellen von Volumes](storage-spaces/create-volumes.md)
#### [Geschachtelte Ausfallsicherheit](storage-spaces/nested-resiliency.md)
#### [Konfigurieren von Quorum](../failover-clustering/manage-cluster-quorum.md)
#### [Upgrade eines Storage Spaces Direct-Clusters auf Windows Server 2019](storage-spaces/upgrade-storage-spaces-direct-to-windows-server-2019.md)
### Verwalten
#### [Mit Windows Admin Center verwalten](../manage/windows-admin-center/use/manage-hyper-converged.md)
#### [Hinzufügen von Servern oder Laufwerken](storage-spaces/add-nodes.md)
#### [Server zu Wartungszwecken offline schalten](storage-spaces/maintain-servers.md)
#### [Server entfernen](storage-spaces/remove-servers.md)
...
##### [Laufwerke](storage-spaces/performance-history-for-drives.md)
##### [Netzwerkadapter](storage-spaces/performance-history-for-network-adapters.md)
...
#### [Begrenzen der Zuweisung von Volumes](storage-spaces/delimit-volume-allocation.md)
#### [Überwachung mit Azure Monitor](storage-spaces/configure-azure-monitor.md)
### Problembehandlung
...
#### [Schritt2: Post-Konfiguration von AD FS](work-folders/deploy-work-folders-adfs-step2.md)
#### [Schritt 3: Einrichten von Arbeitsordnern](work-folders/deploy-work-folders-adfs-step3.md)
#### [Schritt4: Einrichten von WAP](work-folders/deploy-work-folders-adfs-step4.md)
...
## [Änderungsverlauf für Speicher-Themen](storage-change-history.md)
