...
| Verwandte Technologien|[Identität und Zugriff in Windows Server](../../identity/identity-and-access.md)<br>[Speicher](../storage.md)<br>[Remotezugriff und Serververwaltung](../../remote/index.md) |