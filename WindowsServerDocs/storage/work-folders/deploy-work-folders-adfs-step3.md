...
4.  Wählen Sie im Fenster **Einstellungen für Arbeitsordner** die Option **Active Directory-Verbunddienste (AD FS)** aus, und geben Sie die Verbunddienst-URL ein. Klicken Sie auf **Übernehmen**.
