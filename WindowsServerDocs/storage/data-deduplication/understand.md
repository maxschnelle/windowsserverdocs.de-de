...
| <a id="usage-type-backup"></a>Sicherung | Virtualisierte Sicherungsprogramme wie [Microsoft Data Protection Manager (DPM)](https://technet.microsoft.com/library/hh758173.aspx) | <ul><li>Optimierung mit Prioritäten</li><li>Standardoptimierungsrichtlinie:<ul><li>Minimales Dateialter = 0 Tage</li><li>Optimieren verwendeter Dateien = Ja</li><li>Teilweises Optimieren von Dateien = Nein</li></ul></li><li>„Verdeckte“ Optimierungsmethoden für Interoperabilität mit DPM bzw. DPM-ähnlichen Lösungen</li></ul> |
