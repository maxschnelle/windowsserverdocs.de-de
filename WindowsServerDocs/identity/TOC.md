...
### [Dynamische Zugriffssteuerung: Szenarioübersicht](solution-guides/Dynamic-Access-Control--Scenario-Overview.md)
...
#### [Szenario: Klassifizierung basierend auf der Verschlüsselung für Office-Dokumente](solution-guides/Scenario--Classification-Based-Encryption-for-Office-Documents.md)
...
#### [Bereitstellen von Ansprüchen über Gesamtstrukturen](solution-guides/Deploy-Claims-Across-forests.md)
##### [Bereitstellen von Ansprüchen über Gesamtstrukturen (Demonstrationsschritte)](solution-guides/Deploy-Claims-Across-forests--Demonstration-Steps-.md)
...
### [Neues in Active Directory Domain Services](whats-new-active-directory-domain-services.md)

### [Erste Schritte mit AD DS](ad-ds/AD-DS-Getting-started.md)
#### [Übersicht über Active Directory Domain Services](ad-ds/get-started/virtual-dc/active-directory-domain-services-overview.md)

#### [Active Directory-Verwaltungscenter](ad-ds/get-started/adac/active-directory-Administrative-Center.md)
##### [AD Papierkorb, abgestimmte Kennwortrichtlinie, und PowerShell-Verlauf](ad-ds/get-started/adac/Introduction-to-active-directory-Administrative-Center-Enhancements--Level-100-.md)
##### [Erweiterte ADDS-Verwaltung mit dem ActiveDirectory-Verwaltungscenter](ad-ds/get-started/adac/Advanced-AD-DS-Management-Using-active-directory-Administrative-Center--Level-200-.md)
...
##### [Einführung in die Virtualisierung der Active Directory Domain Services (AD DS) (Ebene100)](ad-ds/Introduction-to-active-directory-Domain-Services-AD-DS-Virtualization-Level-100.md)
##### [Technische Referenz für virtualisierte Domänencontroller (Level 300)](ad-ds/deploy/virtual-dc/Virtualized-Domain-Controller-Technical-Reference--Level-300-.md)
...
###### [Ausführen von Active Directory auf Azure-VMs](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
##### [Testleitfaden: Klonen von virtualisierten Domänencontrollern für Anwendungsanbieter](ad-ds/reference/virtual-dc/Virtualized-Domain-Controller-Cloning-Test-Guidance-for-Application-Vendors.md)
...
#### [Zuordnen Ihren Anforderungen zu einer AD DS-Bereitstellungsstrategie](ad-ds/plan/Mapping-Your-Requirements-to-an-AD-DS-Deployment-Strategy.md)
...
##### [Erstellen eines Entwurfs der DNS-Infrastruktur](ad-ds/plan/Creating-a-DNS-Infrastructure-Design.md)
...
###### [Integrieren von AD DS in eine vorhandene DNS-Infrastruktur](ad-ds/plan/Integrating-AD-DS-into-an-Existing-DNS-Infrastructure.md)
...
##### [Sammeln von Informationen zum Netzwerk](ad-ds/plan/Collecting-Network-Information.md)
...
##### [Suchen zusätzlicher Ressourcen für den Entwurf der Windows Server 2008 Active Directory-Standorttopologie](ad-ds/plan/finding-additional-Resources-for-Windows-Server-2008-active-directory-Site-Topology-Design.md)
##### [Anhang A: Speicherorte und Subnetzpräfixe](ad-ds/plan/appendix-A--Locations-and-Subnet-Prefixes.md)
#### [Aktivieren erweiterter Funktionen für AD DS](ad-ds/plan/Enabling-Advanced-Features-for-AD-DS.md)
##### [Windows Server-Funktionsebenen](ad-ds/active-directory-functional-levels.md)
##### [Bestimmen der Funktionsebenenupgrades](ad-ds/plan/Identifying-Your-Functional-Level-Upgrade.md)
...
#### [Upgrade von Domänencontrollern auf WindowsServer2016](ad-ds/deploy/upgrade-domain-controllers.md)
#### [Upgrade von Domänencontrollern auf Windows Server 2012 R2 und Windows Server 2012](ad-ds/deploy/Upgrade-Domain-Controllers-to-Windows-Server-2012-R2-and-Windows-Server-2012.md)
#### [Vereinfachte Verwaltung für AD DS](ad-ds/manage/AD-DS-Simplified-Administration.md)
##### [Anhang für vereinfachte Verwaltung](ad-ds/deploy/Simplified-Administration-appendix.md)
#### [Installieren von Active Directory Domain Services](ad-ds/deploy/Install-active-directory-Domain-Services--Level-100-.md)
##### [Installieren einer neuen Windows Server Active Directory-Gesamtstruktur](ad-ds/deploy/Install-a-New-Windows-Server-2012-active-directory-forest--Level-200-.md)
...
##### [Installieren einer neuen untergeordneten Active Directory-Domäne oder -Strukturdomäne in Windows Server](ad-ds/deploy/Install-a-New-Windows-Server-2012-active-directory-Child-or-tree-Domain--Level-200-.md)
##### [Installieren eines schreibgeschützten Active Directory-Domänencontrollers (RODC) in Windows Server 2012](ad-ds/deploy/RODC/Install-a-Windows-Server-2012-active-directory-Read-Only-Domain-Controller--RODC---Level-200-.md)
#### [Tieferstufen von Domänencontrollern](ad-ds/deploy/Demoting-Domain-Controllers-and-Domains--Level-200-.md)
##### [AD DS-Metadaten-Bereinigung](ad-ds/deploy/ad-ds-metadata-cleanup.md)
#### [Beschreibungen der Seiten des Assistenten zum Installieren und Entfernen von AD DS](ad-ds/deploy/AD-DS-Installation-and-removal-Wizard-Page-Descriptions.md)
...
#### [AD-Gesamtstruktur-Wiederherstellungsleitfaden](ad-ds/manage/AD-Forest-Recovery-Guide.md)
...
##### [AD Gesamtstruktur-Wiederherstellung - identifizieren Sie das Problem](ad-ds/manage/AD-Forest-Recovery-Identify-the-Problem.md)
##### [AD Gesamtstruktur-Wiederherstellung - anfänglichen Datenwiederherstellung](ad-ds/manage/AD-Forest-Recovery-Perform-initial-recovery.md)
...
##### [AD-Gesamtstruktur Recovery - wiederherstellen eine einzelne Domäne mit Gesamtstruktur mit mehreren Domänen](ad-ds/manage/AD-Forest-Recovery-Single-Domain-in-Multidomain-Recovery.md)
...
#### [Bewährte Methoden für die Sicherung von Active Directory](ad-ds/plan/security-best-practices/Best-Practices-for-Securing-active-directory.md)
##### [Kurzfassung](ad-ds/manage/component-updates/executive-Summary.md)
...
##### [Implementieren von Verwaltungsmodellen der geringste Rechte](ad-ds/plan/security-best-practices/Implementing-Least-Privilege-Administrative-models.md)
##### [Implementieren von sicheren Verwaltungshosts](ad-ds/plan/security-best-practices/Implementing-Secure-Administrative-Hosts.md)
...
###### [Winlogon-Anmeldung nach einem automatischen Neustart](ad-ds/manage/component-updates/winlogon-automatic-restart-sign-on--arso-.md)
###### [TPM-Schlüsselnachweis](ad-ds/manage/component-updates/TPM-Key-attestation.md)
###### [Windows PowerShell-Cmdlets für die Sicherung und Wiederherstellung von Zertifizierungsstellen](ad-ds/manage/component-updates/CA-Backup-and-Restore-Windows-powershell-cmdlets.md)
...
#### [Konfigurieren geschützter Benutzerkonten](ad-ds/manage/how-to-configure-protected-accounts.md)
...
#### [Problembehandlung für Active Directory-Replikation](ad-ds/manage/troubleshoot/Troubleshooting-active-directory-Replication-Problems.md)
...
### [AD FS (Übersicht)](ad-fs/AD-FS-Overview.md)
#### [Neues in Active Directory-Verbunddienste (AD FS)](ad-fs/overview/whats-new-active-directory-federation-services-windows-server.md)
...
###### [ADFS-Anforderungen](ad-fs/design/AD-FS-Requirements.md)
...
####### [Bereitstellen des Zugriffs auf Ihre Ansprüche unterstützenden Anwendungen und Dienste für die Benutzer anderer Organisationen](ad-fs/design/Provide-Users-in-Another-Organization-Access-to-Your-Claims-Aware-Applications-and-Services.md)
...
###### [Identifizieren der AD FS-Bereitstellungstopologie](ad-fs/design/Determine-Your-AD-FS-Deployment-Topology.md)
...
####### [Planen der Interoperabilität mit ADFS 1.x](ad-fs/design/Planning-for-Interoperability-with-AD-FS-1.x.md)
...
####### [Konfigurieren von AD FS in der Ressourcenpartnerorganisation](ad-fs/design/Deploying-AD-FS-in-the-Resource-Partner-Organization-2012.md)
...
######## [Bestimmen der Verbundanwendungsstrategie im Ressourcenpartner](ad-fs/design/Determine-Your-Federated-Application-Strategy-in-the-Resource-Partner.md)
...
#### [Einrichten der geografischen Redundanz mit der SQL Server-Replikation](ad-fs/deployment/Set-up-Geographic-Redundancy-with-SQL-Server-Replication.md)
...
#### [Upgrade auf AD FS in Windows Server2016 unter Verwendung einer WID-Datenbank](ad-fs/deployment/Upgrading-to-AD-FS-in-Windows-Server.md)
...
#### [Upgrade auf AD FS in Windows Server2016 unter Verwendung einer SQL-Datenbank](ad-fs/deployment/Upgrading-to-AD-FS-in-Windows-Server-SQL.md)
#### [Bereitstellen von Azure AD Connect Health zum Überwachen der lokale Identität-Infrastruktur in der cloud](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-health)
...
###### [Überprüfen, ob der Windows Server 2012 R2-Verbundserver betriebsbereit ist](ad-fs/deployment/verify-your-Windows-Server-2012-R2-Federation-Server-Is-Operational.md)
...
##### [Checkliste: Implementieren eines Web-SSO-Entwurfs](ad-fs/deployment/Checklist--Implementing-a-Web-SSO-Design.md)
##### [Checkliste: Implementieren eines Entwurfs für Federated-Web-SSO](ad-fs/deployment/Checklist--Implementing-a-Federated-Web-SSO-Design.md)
##### [Konfigurieren von Partnerorganisationen](ad-fs/deployment/Configuring-Partner-Organizations.md)
###### [Checkliste: Konfigurieren der Kontopartnerorganisation](ad-fs/deployment/Checklist--Configuring-the-Account-Partner-Organization.md)
###### [Checkliste: Konfigurieren der Ressourcenpartnerorganisation](ad-fs/deployment/Checklist--Configuring-the-Resource-Partner-Organization.md)
...
###### [Clientcomputer so konfigurieren, dass sie dem Kontoverbundserver vertrauen](ad-fs/deployment/Configure-Client-computers-to-Trust-the-Account-Federation-Server.md)
...
###### [Checkliste: Erstellen von Anspruchsregeln für eine Anspruchsanbieter-Vertrauensstellung](ad-fs/deployment/Checklist--Creating-Claim-Rules-for-a-Claims-Provider-Trust.md)
###### [Checkliste: Erstellen von Anspruchsregeln für eine Vertrauensstellung der vertrauenden Seite](ad-fs/deployment/Checklist--Creating-Claim-Rules-for-a-Relying-Party-Trust.md)
...
###### [Checkliste: Einrichten eines Verbundservers](ad-fs/deployment/Checklist--Setting-Up-a-Federation-Server.md)
...
###### [Hinzufügen eines Tokenverschlüsselungszertifikats](ad-fs/deployment/add-a-Token-Decrypting-Certificate.md)
###### [Festlegen eines Dienstkommunikationszertifikats](ad-fs/deployment/Set-a-Service-Communications-Certificate.md)
###### [Überprüfen, ob ein Verbundserver betriebsbereit ist](ad-fs/deployment/verify-That-a-Federation-Server-Is-Operational.md)
##### [Bereitstellen von Verbundserverproxys](ad-fs/deployment/Deploying-Federation-Server-Proxies.md)
###### [Checkliste: Einrichten eines Verbundserverproxys](ad-fs/deployment/Checklist--Setting-Up-a-Federation-Server-Proxy.md)
###### [Hinzufügen eines Computers zu einer Domäne](ad-fs/deployment/Join-a-computer-to-a-Domain.md)
...
###### [Exportieren des Teils eines privaten Schlüssels aus einem Serverauthentifizierungszertifikat](ad-fs/deployment/Export-the-Private-Key-Portion-of-a-Server-Authentication-Certificate.md)
...
##### [Interaktion mit AD FS 1.x](ad-fs/deployment/Interoperating-with-AD-FS-1.x.md)
###### [Checkliste: AD FS so konfigurieren, dass Ansprüche von AD FS 1.x genutzt werden](ad-fs/deployment/Checklist--Configuring-AD-FS--to-Consume-Claims-from-AD-FS-1.x.md)
###### [Checkliste: AD FS so konfigurieren, dass Ansprüche an einen AD FS 1.x-Verbunddienst gesendet werden](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Federation-Service.md)
###### [Checkliste: AD FS so konfigurieren, dass Ansprüche an einen Ansprüche unterstützenden AD FS 1.x-Web-Agent gesendet werden](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Claims-Aware-Web-Agent.md)
###### [Manuelles Erstellen einer Vertrauensstellung der vertrauenden Seite](ad-fs/operations/create-a-Relying-Party-Trust.md)
###### [Manuelles Erstellen einer Vertrauensstellung eines Anspruchsanbieters](ad-fs/operations/create-a-Claims-Provider-Trust.md)
###### [Erstellen einer Regel zum Senden eines AD FS 1.x-kompatiblen Anspruchs](ad-fs/operations/create-a-Rule-to-Send-an-AD-FS-1x-compatible-Claim.md)
...
#### [Migrieren von Rollendiensten der Active Directory Federation zu Windows Server 2012 R2](ad-fs/deployment/migrate-ad-fs-service-role-to-windows-server-r2.md)
##### [Vorbereiten der Migration von des AD FS-Verbundservers](ad-fs/deployment/prepare-migrate-ad-fs-server-r2.md)
#####[Migrieren des AD FS-Verbundservers](ad-fs/deployment/migrate-ad-fs-fed-server-r2.md)
#####[Migrieren von AD FS-Verbundserverproxys](ad-fs/deployment/migrate-fed-server-proxy-r2.md)
#####[Bestätigung der AD FS-Migration zu Windows Server 2012 R2](ad-fs/deployment/verify-ad-fs-migration.md)

#### [Migrieren von Rollendiensten der Active Directory-Verbunddienste (AD FS) zu WindowsServer2012](ad-fs/deployment/migrate-ad-fs-role-services-to-windows-server-2012.md)
##### [Vorbereiten der Migration des ADFS2.0-Verbundservers](ad-fs/deployment/prepare-to-migrate-ad-fs-fed-server.md)
######[Vorbereiten der Migration von AD FS 2.0 Ständer allein oder eine einzelne Knoten-Farm-Servers](ad-fs/deployment/prepare-to-migrate-a-stand-alone-ad-fs-federation-server.md)
######[Vorbereiten der Migration der AD FS 2.0 WID Farm](ad-fs/deployment/prepare-to-migrate-a-wid-farm.md)
######[Vorbereiten der Migration von der AD FS 2.0 SQL-Farm](ad-fs/deployment/prepare-to-migrate-a-sql-server-farm.md)
#####[Vorbereiten der Migration des AD FS 2.0 Verbundserverproxys](ad-fs/deployment/prepare-to-migrate-ad-fs-fed-proxy.md)
#####[Migrieren des ADFS2.0-Verbundservers](ad-fs/deployment/migrate-the-ad-fs-fed-server.md)
######[Migrieren Sie die AD FS 2.0 Ständer allein oder eine einzelne Knoten Farm-Servers](ad-fs/deployment/migrate-ad-fs-stand-alone-server.md)
...
#### [AD FS: Authentifizierung im Auftrag einer anderen Person in Windows Server 2016](ad-fs/development/AD-FS-On-behalf-of-Authentication-in-Windows-Server.md)
...
#### [Einzelne Abmeldung für OpenID Connect mit AD FS](ad-fs/development/ad-fs-logout-openid-connect.md)
#### [Einzelseitenanwendung mit AD FS](ad-fs/development/Single-Page-Application-with-AD-FS.md)
#### [Erstellen Sie eine native Clientanwendung mit öffentlichen OAuth-Clients mit AD FS](ad-fs/development/native-client-with-ad-fs.md)
...
##### [Zugriffsrichtlinien in AD FS für Windows Server2016](ad-fs/operations/Access-Control-Policies-in-AD-FS.md)
##### [Zugriffsrichtlinien in AD FS für Windows Server 2012 R2](ad-fs/operations/Access-Control-Policies-W2K12.md)
...
#### [Unterstützung von AD FS-Aufforderung Anmelde-parameter](ad-fs/operations/AD-FS-Prompt-Login.md)
...
#### [AD FS-Unterstützung für alternative Hostnamenbindung für Zertifikatauthentifizierung](ad-fs/operations/AD-FS-support-for-alternate-hostname-binding-for-certificate-authentication.md)
#### [AD FS: Anpassung der Benutzeranmeldung](ad-fs/operations/AD-FS-user-sign-in-customization.md)
#### [Hinzufügen eines Attributspeichers](ad-fs/operations/add-an-attribute-Store.md)
#### [Zusammengesetzte Authentifizierung und AD DS-Ansprüchen in AD FS](ad-fs/operations/AD-FS-Compound-Authentication-and-AD-DS-claims.md)
#### [Konfigurieren von AD FS für die Benutzerauthentifizierung Zertifikat](ad-fs/operations/Configure-User-Certificate-Authentication.md)
#### [Konfigurieren von AD FS 2016 und Azure MFA](ad-fs/operations/Configure-AD-FS-and-Azure-MFA.md)
#### [Konfigurieren von AD FS weiche-Extranet-Sperre Schutz](ad-fs/operations/Configure-AD-FS-Extranet-Soft-Lockout-Protection.md)
#### [Konfigurieren von AD FS Smart-Extranet-Sperre Schutz](ad-fs/operations/Configure-AD-FS-Extranet-Smart-Lockout-Protection.md)
...
#### [Konfigurieren von alternativen Anmelde-ID](ad-fs/operations/Configuring-Alternate-Login-ID.md)
...
#### [Anpassen der Sicherheitsheader in HTTP-Antworten mit AD FS](ad-fs/operations/customize-http-security-headers-ad-fs.md)
#### [Delegieren von AD FS-Powershell-Cmdlet-Zugriff an Nicht-Administratoren](ad-fs/operations/delegate-ad-fs-pshell-access.md)
#### [Steuerelemente zur Geräteauthentifizierung in AD FS](ad-fs/operations/device-authentication-controls-in-AD-FS.md)
...
#### [Verwalten von SSL-Protokolle in AD FS](ad-fs/operations/Manage-SSL-Protocols-in-AD-FS.md)
#### [Planen des gerätebasierten bedingten lokalen Zugriffs](ad-fs/deployment/Plan-Device-based-Conditional-Access-on-Premises.md)
...
#### [Exemplarische Vorgehensweise: Workplace Join mit einem Android-Gerät](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)

### [Problembehandlung für AD FS](ad-fs/troubleshooting/ad-fs-tshoot-overview.md)
#### [AD FS-Hilfe Diagnose Analyzer](ad-fs/troubleshooting/ad-fs-diagnostics-analyzer.md)
#### [Azure](ad-fs/troubleshooting/ad-fs-tshoot-azure.md)
#### [Zertifikate](ad-fs/troubleshooting/ad-fs-tshoot-certs.md)
#### [Ansprüche-syntax](ad-fs/troubleshooting/ad-fs-tshoot-claims-rules.md)
...
### [Technische Referenzen zu AD FS](ad-fs/AD-FS-Technical-Reference.md)
#### [Schutz der Privatsphäre und AD FS](ad-fs/technical-reference/GDPR-and-AD-FS-Compliance.md)
#### [AD FS und KeySpec-Eigenschaftsinformationen des Zertifikats](ad-fs/technical-reference/AD-FS-and-KeySpec-Property.md)
#### [Überwachung von Erweiterungen für AD FS unter Windows Server](ad-fs/technical-reference/auditing-enhancements-to-ad-fs-in-windows-server.md)
...
##### [Verwendung von URIs in AD FS](ad-fs/technical-reference/How-URIs-Are-Used-in-AD-FS.md)
#### [Technische Referenzen zur Geräteregistrierung](ad-fs/technical-reference/device-registration-technical-reference.md)
#### [AD FS-Angriff Kennwortschutz](ad-fs/technical-reference/ad-fs-password-protection.md)
### [FAQ zu ADFS2016](ad-fs/overview/AD-FS-FAQ.md)
...
## [Richtlinien für die Softwareeinschränkung](software-restriction-policies/software-restriction-policies.md)
### [Richtlinien zur Softwareeinschränkung (Software Restriction Policies, SRP) – Technische Übersicht](software-restriction-policies/software-restriction-policies-technical-overview.md)
...
#### [Arbeiten mit Regeln der Richtlinien für die Softwareeinschränkung](software-restriction-policies/work-with-software-restriction-policies-rules.md)
### [Verwenden von Richtlinien für die Softwareeinschränkung zum Schutz Ihres Computers vor einem E-Mail-Virus](software-restriction-policies/use-software-restriction-policies-to-help-protect-your-computer-against-an-email-virus.md)
### [Problembehandlung bei Richtlinien für Softwareeinschränkung](software-restriction-policies/troubleshoot-software-restriction-policies.md)
