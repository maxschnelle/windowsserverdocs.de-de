...
## <a name="next-steps"></a>Nächste Schritte
 [Migrieren Active Directory-Verbunddienste (AD FS) Rollen Dienste zu Windows Server 2012 R2 migrieren](migrate-ad-fs-service-role-to-windows-server-r2.md) [des AD FS Verbund Servers](migrate-ad-fs-fed-server-r2.md) Migrieren des [AD FS Verbund Server Proxy](migrate-fed-server-proxy-r2.md) [Überprüfen der AD FS Migration zu Windows Server 2012 R2](verify-ad-fs-migration.md)
