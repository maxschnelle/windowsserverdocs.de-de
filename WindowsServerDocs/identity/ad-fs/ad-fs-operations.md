...
- [Konfigurieren Azure AD Anmeldungs Verhalten der Eingabeaufforderung zum Arbeiten mit AD FS Richtlinie](../ad-fs/operations/AD-FS-Prompt-Login.md)

### <a name="kerberos--certificate-authentication"></a>Kerberos-& Zertifikat Authentifizierung
- [Aktivieren Sie AD DS Ansprüche & die Kerberos-Verbund Authentifizierung in AD FS](../ad-fs/operations/AD-FS-Compound-Authentication-and-AD-DS-claims.md)
- [Konfigurieren von AD FS für die Benutzerzertifikat Authentifizierung](../ad-fs/operations/Configure-User-Certificate-Authentication.md)
- [Konfigurieren alternativer Hostname-Bindungen für die Zertifikat Authentifizierung in AD FS](../ad-fs/operations/AD-FS-support-for-alternate-hostname-binding-for-certificate-authentication.md)
