...
title: Schema Aktualisierungen in Windows Server
description: Schema Änderungen, die von adprep nach Betriebssystemversion vorgenommen wurden
...
ms.locfileid: "71369607"
---
# <a name="windows-server-active-directory-schema-updates"></a>Windows Server Active Directory Schema Updates

>Gilt für: Windows Server

In diesem Thema werden die LDF-Dateien aufgelistet, die die Änderungen enthalten, die von Adprep. exe vorgenommen werden.  

Dies ist die LDF-Datei, die in Windows Server 2019 enthalten ist:

-   [Sch88. ldf](#BKMK_Sch88)

Dies sind die LDF-Dateien, die in Windows Server 2016 enthalten sind:
...
Dies sind die LDF-Dateien, die in Windows Server 2012 R2 enthalten sind:  
...
Dies sind die LDF-Dateien, die in Windows Server 2012 enthalten sind:  
...
## <a name="schema-update-in-windows-server-2019"></a>Schema Aktualisierung in Windows Server 2019
...
## <a name="schema-updates-in-windows-server-2016"></a>Schema Aktualisierungen in Windows Server 2016
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Schema Aktualisierungen in Windows Server 2012 R2  
...
## <a name="BKMK_SchemaUpdates2012"></a>Schema Aktualisierungen in Windows Server 2012  
