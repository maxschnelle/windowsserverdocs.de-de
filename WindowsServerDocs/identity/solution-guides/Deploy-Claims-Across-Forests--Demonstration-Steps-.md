...
## <a name="set-up-the-prerequisites-and-the-test-environment"></a><a name="BKMK_1.1"></a>Einrichten der Voraussetzungen und der Testumgebung
...
4.  [Erstellen der zentralen Zugriffsregel](Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.9)

5.  [Erstellen der zentralen Zugriffsrichtlinie](Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.10)

6.  [Veröffentlichen der neuen Richtlinie über die Gruppenrichtlinie](Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.11)
...
## <a name="set-up-claims-transformation-on-trusted-forest-adatum"></a><a name="BKMK_3"></a>Einrichten der Anspruchs Transformation in einer vertrauenswürdigen Gesamtstruktur (Adatum)
...
1. Melden Sie sich beim Domänen Controller adatum.com als Administrator mit dem Kennwort an <strong>pass@word1</strong> .
...
1. Melden Sie sich beim Domänen Controller contoso.com als Administrator mit dem Kennwort an <strong>pass@word1</strong> .
...
1. Melden Sie sich am Client Computer Client1 als Jeff Low mit dem Kennwort an <strong>pass@word1</strong> .
