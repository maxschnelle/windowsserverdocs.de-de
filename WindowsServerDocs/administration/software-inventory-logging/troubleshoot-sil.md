---
title: Problembehandlung der Protokollierung des Software Bestands
...
![SIL-Framework-Diagramm](../media/software-inventory-logging/image1.png)
...
1. Öffnen Sie **PowerShell** als Administrator, und führen Sie das Cmdlet " **Get-silvmhost** " aus.
    ...
    -   Wenn Hosts aufgelistet werden und **HostType** und **"hypervisortype"** mit nicht **unbekannten**Werten aufgelistet sind, d. h. Windows und HyperV, Ubuntu und Xen usw., aber es ist kein **DateTime** -Wert unter **letzte Umfrage** Spalte vorhanden. der Abruf wurde noch nicht erfolgreich durchgeführt.
        ...
        -   Wenn seit dem Hinzufügen des Hosts eine Stunde vergangen ist, überprüfen Sie, ob der Abruf Task ausgeführt wird: Wählen Sie in **Taskplaner**unter **Microsoft** Windows den **Aggregator der Protokollierung des Software Bestands** aus, &gt; **Windows** und überprüfen Sie den Verlauf der Aufgabe.
...
2. Starten Sie PowerShell als Administrator.
