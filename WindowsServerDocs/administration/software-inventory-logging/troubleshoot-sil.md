...
2. Führen Sie **Get-Silvmhost**
 ...
 - Wenn Hosts, als aufgelistet sind **unbekannte**, navigieren Sie zu dem Problem 2. d – Wenn Hosts aufgelistet sind, aber es gibt keine **"DateTime"** unter der **jüngsten Abrufs** Spalte, und klicken Sie dann auf Gehe zu **Problem 2** unten.
