---
title: 'Hierbei gilt:'
description: Referenz Thema für WHERE, in dem der Speicherort der Dateien angezeigt wird, die dem angegebenen Suchmuster entsprechen.
