...
|    \<File>     | Gibt die zu kopierenden Dateien an. Sie können Platzhalter Zeichen (**&#42;** oder **?**) verwenden, wenn Sie möchten. Wenn der **File** -Parameter nicht angegeben wird, wird als Standardwert verwendet ** \* . \* ** |
|   \<Options>   |                                                                    Gibt Optionen an, die mit dem **Robocopy** -Befehl verwendet werden sollen.                                                                   |
