...
- Aufgaben, die nach 72 Stunden beendet werden  
  ...
  3.  Klicken Sie im Menü Bearbeiten auf Wert hinzufügen, und fügen Sie dann den folgenden Registrierungs Wert hinzu: Wertname: attaskmaxhours Datentyp: reg_DWOrd Radix: decimal value Data: 0. Der Wert 0 (null) im WertDatenfeld gibt an, dass keine Begrenzung nicht beendet wird. Werte von 1 bis 99 gibt die Anzahl der Stunden an.
  **Vorsicht**
