...
|-------|--------|
|[Nslookup-Exit-Befehl](nslookup-exit-command.md)|beendet **Nslookup**.|
|[Nslookup-Finger-Befehl](nslookup-finger-command.md)|Eine Verbindung mit dem Fingerserver, auf dem aktuellen Computer.|
...
|[Nslookup alle festlegen](nslookup-set-all.md)|Gibt die aktuellen Werte der Konfigurationseinstellungen.|
|[Nslookup set-Klasse](nslookup-set-class.md)|Ändert die Abfrageklasse. Die Klasse gibt die Protokollgruppe, der die Informationen an.|
...
|[Nslookup festgelegt Debug.](nslookup-set-debug.md)|Schaltet den Debugmodus, ein- oder ausschalten.|
...
|[Nslookup festgelegt Port.](nslookup-set-port.md)|ändert sich der Standardport des TCP/UDP-DNS-Namen auf den angegebenen Wert.|
...
|[Nslookup-Satz "Wiederholen"](nslookup-set-retry.md)|Legt die Anzahl von Wiederholungen fest.|
|[Nslookup festlegen Stamm](nslookup-set-root.md)|Ändert den Namen des Stammservers für Abfragen verwendet.|
|[Nslookup-Set-Suche](nslookup-set-search.md)|Fügt die DNS-Domänennamen in der Suchliste für DNS-Domäne auf die Anforderung, bis eine Antwort empfangen wird. Dies gilt, wenn die Gruppe und die Suche nach Anforderung muss mindestens einen Punkt enthalten, aber nicht mit einem Punkt enden.|
...
|[Nslookup resultsettyps](nslookup-set-type.md)|Ändert den Typ des Ressourcendatensatzes für die Abfrage an.|
...
|[Nslookup-Ansicht](nslookup-view.md)|sortiert und zeigt die Ausgabe des vorherigen **ls** Unterbefehl oder Befehle.|
