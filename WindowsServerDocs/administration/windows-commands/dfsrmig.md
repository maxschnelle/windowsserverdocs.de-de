---
title: dfsrmig
description: Referenz Thema für DFSRMIG zum Migrieren der SYSVOL-Replikation von Datei Replikations Dienst (File Replication Service, FRS) verteiltes Dateisystem zur DFS-Replikation (DFS), Bereitstellen von Informationen zum Fortschritt der Migration und Ändern der Active Directory-Domänen Dienste (AD DS)-Objekte zur Unterstützung der Migration
