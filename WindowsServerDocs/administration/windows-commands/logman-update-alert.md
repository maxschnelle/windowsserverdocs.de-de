...
ms.locfileid: "89639956"
---
# <a name="logman-update-alert"></a>logman update alert

> Gilt für: Windows Server (halbjährlicher Kanal), Windows Server 2019, Windows Server 2016, Windows Server 2012 R2, Windows Server 2012

Aktualisiert die Eigenschaften eines vorhandenen Warnungs Daten Sammlers.
...
Um die vorhandene Warnung mit dem Namen *new_alert*zu aktualisieren, geben Sie Folgendes ein, um den Schwellenwert für den Leistungs Schwellenwert "% Processor Time" in der Leistungs Regel "Prozessor" (_Total) auf 40%
...
- [logman Create Alert-Befehl](logman-create-alert.md)
