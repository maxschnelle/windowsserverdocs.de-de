...
|\<PromptString>|Dies ist optional. Gibt an, eine Nachricht an den Benutzer zur Eingabe aufzufordern. Dieser Parameter wird verwendet, mit der **/p** Befehlszeilenoption.|
