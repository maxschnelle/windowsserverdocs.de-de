...
-   Verwenden von Batchparametern
    ...
    -   Die **für** -Befehl ersetzt **% *** Variable* oder **%% *** Variable* mit jeder Zeichenfolge in der angegebenen Menge aus, bis der angegebene Befehl alle Dateien verarbeitet.
...
-   Angeben einer Gruppenstatus von Dateien
    ...
    (ar??1991.* ap??1991.*)
    ```  
    Bei Verwendung der **für** Befehl, den ersten Wert in *festgelegt* ersetzt **% *** Variable* oder **%% *** Variable*, und klicken Sie dann die angegebenen Befehl verarbeitet. Dieser Vorgang wird fortgesetzt, bis alle Dateien (oder Gruppen von Dateien), die entsprechen, den *festgelegt* Wert verarbeitet werden.
