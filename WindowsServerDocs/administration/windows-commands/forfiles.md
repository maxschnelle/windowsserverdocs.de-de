...
|----------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     /p \<path >                     |                                                                                                                                                                                                                                                 Gibt den Pfad an, aus dem die Suche gestartet werden soll. Standardmäßig beginnt die Suche im aktuellen Arbeitsverzeichnis.                                                                                                                                                                                                                                                  |
...
| /d @ no__t-0 [{+ \|-}]&#8288;[{\<date > \|&#8288;\<days >}] | Wählt Dateien mit dem Datum der letzten Änderung innerhalb des angegebenen Zeitraums aus.</br>: Wählt Dateien mit dem Datum der letzten Änderung, das später als oder gleich ( **+** ) oder früher als oder gleich ( **-** ) ist, zum angegebenen Datum aus, wobei *Date* das Format mm/dd/yyyy hat.</br>-Wählt Dateien mit einem Datum der letzten Änderung, das später als oder gleich ( **+** ) ist, das aktuelle Datum zuzüglich der angegebenen Anzahl von Tagen oder früher als oder gleich ( **-** ) dem aktuellen Datum abzüglich der angegebenen Anzahl von Tagen aus.</br>-Gültige Werte für *Tage* umfassen eine beliebige Zahl im Bereich 0 – 32768. Wenn kein Vorzeichen angegeben ist, wird standardmäßig **+** verwendet. |
...
-   Mit **forfiles**können Sie eine der folgenden Aktionen ausführen:  
    ...
    -   Erstellen Sie eine Archivstruktur von Dateien, indem Sie Variablen wie @FSIZE und @FDATE verwenden.
