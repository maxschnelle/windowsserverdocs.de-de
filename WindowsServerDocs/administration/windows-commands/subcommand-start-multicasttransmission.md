...
description: Windows-Befehls Thema für den Unterbefehl Start-MulticastTransmission, mit dem eine Übertragung eines Bilds mit einem geplanten Cast gestartet wird.
...
[mit dem Befehl "Remove-MulticastTransmission](using-the-remove-multicasttransmission-command.md) " verwendet werden.
