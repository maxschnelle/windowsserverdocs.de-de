...
```
Im Gegenzug **SchTasks.exe** wird die folgende Bestätigung angezeigt. Drücken Sie Y, um die Aufgabe zu löschen,<strong>.</strong> Geben Sie den Befehl um abzubrechen, **n**:
```
