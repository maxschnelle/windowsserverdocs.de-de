...
-   enthält die Informationen, die Sie angeben, Leerzeichen oder Sonderzeichen enthält, verwenden Sie den Text in Anführungszeichen (z. B. **"***Computer Name***"**).
