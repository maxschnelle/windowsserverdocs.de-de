...
|\<Längen>|Gibt die gültige Daten Länge der Datei an.|
...
|\<> der|Gibt die ID der Datei auf einem NTFS-Volume an.|
...
|\<Kurzname>|Gibt den Kurznamen der Datei an.|
