...
```
Das folgende Beispiel veranschaulicht die Verwendung der **Schutzvorrichtungen** Befehl aus, um den Schutz zu deaktivieren, bis der Computer die 3 Mal neu gestartet wurde.
```
