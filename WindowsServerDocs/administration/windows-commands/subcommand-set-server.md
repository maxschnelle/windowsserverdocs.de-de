...
description: Referenz Thema für den Unterbefehl set-Server, der die Einstellungen für einen Windows-Bereitstellungsdiensteserver konfiguriert hat.
...
Befehls "[Subcommand: stop-Server](subcommand-stop-server.md)
[The uninitialize-Server Option](the-uninitialize-server-option.md) Enable-Server" mit dem Befehl "[enable-](using-the-enable-server-command.md)
Server" mithilfe des Befehls "[Get-Server](using-the-get-server-command.md)
" mit dem Befehl "Get-Server"[Unterbefehl "](subcommand-start-server.md)
