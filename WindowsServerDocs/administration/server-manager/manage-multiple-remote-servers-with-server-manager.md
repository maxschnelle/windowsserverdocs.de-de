...
### <a name="BKMK_softconfig"></a>Software-und Konfigurations Anforderungen
...
##### <a name="BKMK_windows"></a>So konfigurieren Sie Server-Manager-Remote Verwaltung unter Windows Server 2012 R2 oder Windows Server 2012 mithilfe der Windows-Benutzeroberfläche
...
##### <a name="BKMK_ps"></a>So aktivieren Sie Server-Manager-Remote Verwaltung unter Windows Server 2012 R2 oder Windows Server 2012 mithilfe von Windows PowerShell
...
2.  Geben Sie Folgendes ein, und drücken **Sie** dann die EINGABETASTE, um alle erforderlichen Firewallregelausnahmen zu aktivieren.
    ...
    **Configure-SMRemoting. exe-enable**
    ...
    Wenn das Aktivieren der Remote Verwaltung fehlschlägt, finden Sie unter [about_remote_Troubleshooting](https://go.microsoft.com/fwlink/p/?LinkID=135188) im Microsoft TechNet Tipps und bewährte Methoden zur Problembehandlung.
...
## <a name="BKMK_restart"></a>Neustarten von Remote Servern
...
## <a name="BKMK_export"></a>Exportieren von Server-Manager Einstellungen auf andere Computer
...
3.  Führen Sie eine der folgenden Aktionen aus.
    ...
    -   In den USA Englisch (en-US) Builds, Änderungen an der Datei " **serverlist. XML** " werden automatisch im Profil gespeichert. Fahren Sie mit dem nächsten Schritt fort.
